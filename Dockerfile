...
# v4.12–v4.14: RHEL 8 image (no -rhel9 variant available)
...
FROM registry.redhat.io/openshift5/ose-operator-registry-rhel9:v5.1.0  AS opm-5-0
...
COPY --from=opm-5-0 /usr/bin/opm /usr/local/bin/opm-v5.0

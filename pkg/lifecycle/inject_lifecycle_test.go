...
func TestInjectLifecycle_CatalogPath_InjectsIntoExistingDir(t *testing.T) {
	...
	// catalog-path points directly to the catalog directory for the package
	...
	if err := InjectLifecycle("ignored.Dockerfile", base, lifecycleDir, "my-operator", "v4.18/catalog/my-operator", nil); err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestInjectLifecycle_CatalogPath_FailsIfDirectoryAbsent(t *testing.T) {
	...
	err := InjectLifecycle("ignored.Dockerfile", base, lifecycleDir, "my-operator", "v4.18/catalog/my-operator", nil)
	if err == nil {
...
func TestInjectLifecycle_CatalogPath_RefusesOverwrite(t *testing.T) {
	...
	err := InjectLifecycle("ignored.Dockerfile", base, lifecycleDir, "my-operator", "catalog/my-operator", nil)
	if err == nil {
		t.Fatal("expected error when lifecycle data already exists, got nil")
	}
}

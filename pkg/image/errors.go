...
var (
	...
	// ErrMissingArchDigest is returned when an image manifest lacks OS, architecture, or digest information.
	ErrMissingArchDigest = errors.New("image manifest does not have an OS, architecture, or digest")
